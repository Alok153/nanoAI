...
- Kotlin 2.2.0 (JDK 17 baseline), Jetpack Compose Material 3, Hilt, WorkManager, Room (SQLite database), DataStore (preferences), Retrofit + Kotlin Serialization, OkHttp, MediaPipe Generative (LiteRT), Coil, Kotlin Coroutines, JUnit5, Detekt, Spotless, Gradle Build Scans, Turbine, planned Roborazzi integration (006-improve-workflow-centralise)
