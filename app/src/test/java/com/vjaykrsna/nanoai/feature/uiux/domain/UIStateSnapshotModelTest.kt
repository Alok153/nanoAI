...
/**
 * Validation-oriented tests for the UIStateSnapshot domain model (T032).
 * Verifies recent action rotation, expanded panel dedupe, and sidebar collapsed persistence.
 */
class UIStateSnapshotModelTest {
    ...
    fun uiState_recentActionsTrimmedToFive() {
        ...
        val args =
            defaultUiStateSnapshotArgs().apply {
                this[2] = List(6) { index -> "action-$index" }
            }
    ...
    fun uiState_expandedPanelsDeduped() {
        ...
        val args =
            defaultUiStateSnapshotArgs().apply {
                this[1] = listOf("panel-1", "panel-1", "panel-2")
            }
    ...
    fun uiState_sidebarCollapsedPersists() {
        ...
        val instance = ctor.newInstance(*args)
        val sidebarCollapsed = instance.javaClass.getMethod("isSidebarCollapsed").invoke(instance) as Boolean
    ...
    private fun getListProperty(
        ...
        return method.invoke(instance) as List<String>
    }
}
