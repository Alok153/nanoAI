...
internal object UiUxDomainTestHelper {
    ...
    fun loadClass(name: String): Class<*> =
        try {
            ...
            fail("Missing class $name. Implement the corresponding UI/UX domain task before running tests.")
        }

    @Suppress("UNCHECKED_CAST")
    fun loadEnumConstant(
        className: String,
        constant: String,
    ): Any {
    ...
    fun primaryConstructor(clazz: Class<*>): Constructor<*> =
        clazz.declaredConstructors
            ...
            ?: fail("Expected ${clazz.name} to declare a primary constructor without DefaultConstructorMarker mask")
}
