...
class ImportServiceImplTest {
    ...
    @Test
    fun `importBackup applies personas providers and settings`() =
        runTest {
            val payload =
                """
                {
    ...
    @Test
    fun `importBackup returns failure for invalid payload`() =
        runTest {
    ...
    private class FakeApiProviderRepository : ApiProviderConfigRepository {
        ...
        override suspend fun getEnabledProviders(): List<APIProviderConfig> = providers.values.filter { it.isEnabled }
