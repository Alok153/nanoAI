...
class ChatMessageDaoTest {
    ...
    @Test
    fun insertChatThread_shouldPersistAndRetrieve() =
        runTest {
            // Arrange
    ...
    @Test
    fun deleteChatThread_shouldCascadeDeleteMessages() =
        runTest {
    ...
    @Test
    fun getMessagesByThreadId_shouldReturnOrderedByCreatedAt() =
        runTest {
    ...
    @Test
    fun messageEntity_shouldStoreRoleEnum() =
        runTest {
            // Arrange
            val threadId = UUID.randomUUID()
            val thread =
    ...
    @Test
    fun messageEntity_shouldStoreSourceEnum() =
        runTest {
            // Arrange
            val threadId = UUID.randomUUID()
            val thread =
    ...
    @Test
    fun messageEntity_shouldStoreLatencyMetrics() =
        runTest {
            // Arrange
            val threadId = UUID.randomUUID()
            val thread =
    ...
    @Test
    fun messageEntity_shouldStoreErrorCode() =
        runTest {
            // Arrange
            val threadId = UUID.randomUUID()
            val thread =
    ...
    @Test
    fun personaSwitchLog_shouldTrackSwitches() =
        runTest {
            // Arrange
            val threadId = UUID.randomUUID()
            val thread =
    ...
    @Test
    fun personaSwitchLog_shouldSupportNullPreviousPersona() =
        runTest {
    ...
    @Test
    fun chatThreadDao_shouldFilterArchivedThreads() =
        runTest {
            // Arrange
            val activeThread =
                ChatThreadEntity(
