...
import com.vjaykrsna.nanoai.core.domain.uiux.UiUxDomainTestHelper.loadEnumConstant
...
internal class UserProfileRepositorySpy {
  ...
  fun asProxy(): Any {
    val repositoryClass =
      loadClass("com.vjaykrsna.nanoai.core.domain.repository.UserProfileRepository")
