 ...
 *
 * TDD note: This test intentionally fails until the production migration copies legacy plaintext
 * entries into the encrypted store and deletes the legacy file.
 */
