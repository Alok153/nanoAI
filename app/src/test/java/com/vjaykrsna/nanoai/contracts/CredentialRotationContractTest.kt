 ...
 *
 * TDD note: These assertions fail until the credential rotation API enforces the
 * documented environments and response metadata defined in the stabilization spec.
 */
