 ...
 *
 * TDD note: these tests are written before the verification endpoint exists and
 * intentionally fail until the contract guarantees retry backoff metadata and
 * integrity failure envelopes.
 */
