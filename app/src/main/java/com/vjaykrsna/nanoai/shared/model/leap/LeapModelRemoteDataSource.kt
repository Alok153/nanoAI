package com.vjaykrsna.nanoai.shared.model.leap
 ...
 */
@Singleton
class LeapModelRemoteDataSource @Inject constructor() {
  ...
  suspend fun getModels(): List<ModelPackage> {
    // TODO: Replace this with a network request to the Leap API to fetch the
    // curated list of models dynamically.
    return listOf(
      LeapModel(
