...
/**
 * Abstraction responsible for aggregating data and producing export bundles
...
interface ExportService {
    ...
    /**
     * Notify user-space that an export bundle is not encrypted and should be stored safely.
     * Default no-op for implementations that surface warning via other channels.
     */
