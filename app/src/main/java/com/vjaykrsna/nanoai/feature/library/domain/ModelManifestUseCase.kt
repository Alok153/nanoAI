...
import com.vjaykrsna.nanoai.shared.model.catalog.*
import com.vjaykrsna.nanoai.shared.model.catalog.network.ModelCatalogService
import com.vjaykrsna.nanoai.shared.model.catalog.network.dto.ErrorEnvelopeDto
import com.vjaykrsna.nanoai.shared.model.catalog.network.dto.ManifestVerificationRequestDto
import com.vjaykrsna.nanoai.shared.model.catalog.network.dto.ManifestVerificationResponseStatusDto
import com.vjaykrsna.nanoai.shared.model.catalog.network.dto.ManifestVerificationStatusDto
import com.vjaykrsna.nanoai.shared.model.catalog.network.dto.ModelManifestDto
import com.vjaykrsna.nanoai.shared.model.huggingface.HuggingFaceManifestFetcher
import com.vjaykrsna.nanoai.shared.model.huggingface.HuggingFaceManifestRequest
...
/**
 * Use case for model manifest operations including fetching, validation, and verification
 * reporting.
 */
@Singleton
class ModelManifestUseCase
@Inject
constructor(
  ...
  private suspend fun cacheManifestAndMetadata(manifest: DownloadManifest) {
    localDataSource.cacheManifest(
      com.vjaykrsna.nanoai.shared.model.catalog.DownloadManifestEntity(
          ...
          when (response.status) {
            ...
            ManifestVerificationResponseStatusDto.RETRY -> {
              ...
              telemetryReporter.report(
                source = "ModelManifestUseCase.reportVerification",
                result = retryResult,
  ...
  private fun <T> httpError(
    ...
    val result: NanoAIResult<T> =
      if (exception.code() in HTTP_BAD_REQUEST..MAX_CLIENT_ERROR_STATUS) {
        NanoAIResult.fatal(
