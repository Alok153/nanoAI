...
import com.vjaykrsna.nanoai.core.data.library.catalog.network.dto.ManifestVerificationStatusDto
...
import com.vjaykrsna.nanoai.core.data.library.huggingface.HuggingFaceManifestRequest
...
constructor(
  ...
  private suspend fun cacheManifestAndMetadata(manifest: DownloadManifest) {
    localDataSource.cacheManifest(
      com.vjaykrsna.nanoai.core.data.db.entities.DownloadManifestEntity(
