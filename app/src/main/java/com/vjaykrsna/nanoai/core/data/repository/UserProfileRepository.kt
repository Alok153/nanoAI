 ...
 *
 * The repository exposes Flow-based observation for reactive UI updates and provides
 * operations for updating preferences, layouts, and UI state. Implementations should
 * prefer offline-first semantics, merging local cached data with remote sources when available.
 */
interface UserProfileRepository {
    /**
     * Observe the merged user profile including DB and DataStore overlays.
     * Emits null if no profile exists for the given userId.
     */
